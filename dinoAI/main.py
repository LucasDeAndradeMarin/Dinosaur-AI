...
RUNNING = [pygame.image.load(os.path.join("imagens/Dino", "DinoRun1.png")),
           pygame.image.load(os.path.join("imagens/Dino", "DinoRun2.png"))]

JUMPING = pygame.image.load(os.path.join("imagens/Dino", "DinoJump.png"))

SMALL_CACTUS = [pygame.image.load(os.path.join("imagens/Cactus", "SmallCactus1.png")),
...
LARGE_CACTUS = [pygame.image.load(os.path.join("imagens/Cactus", "LargeCactus1.png")),
...
BG = pygame.image.load(os.path.join("imagens/Other", "Track.png"))
